...
function ReceiptEmptyState({hasError = false, onPress, disabled = false, isThumbnail = false, isInMoneyRequestView = false, shouldShowFullHeight = false}: ReceiptEmptyStateProps) {
    ...
    return (
        <Wrapper
            ...
            style={[
                ...
                shouldShowFullHeight && styles.h100,
            ]}
        >
            <View>
                <Icon
